        ...
        <Container sx={{width:{xs:"30em",sm:"30em", md:"40em",lg:"40em"}}}>
            <Paper sx={{mt:"8rem",py:"3em",px:"3em", display:"flex", flexDirection:"column", alignItems:"center", bgcolor:"#212121",color:"#eeeeee"}}>
                ...
                <Typography sx={{ fontSize: {xs:'2.5rem', sm:"2.5rem",md:"3rem", lg:"2.7rem"}, mb:"2rem"}} >Welcome to TASKMATE, Signup Here </Typography>
                    ...
                    <TextField sx={{bgcolor:"hsl(0, 0%, 16%)" , width:"100%", marginBottom:"0.5em"}} inputProps={{style:{color:"#eeeeee", fontSize:"1.5em"}}} InputLabelProps={{ style: { color: '#cccccc',fontSize:"1.5rem"} }} label="Email Address" type="email" variant="filled"  ></TextField>
                    ...
                    <Button sx={{fontSize:"1.4rem",mt:"0.8em"}}variant="contained">Signup</Button>
                </Box>
                <Box sx={{mt:"1em"}}>
